...
const unsigned int PUBKEY_MSG_SIZE = 1 + 512 + SIGNATURE_SIZE; //TOOD: ricontrollare
...
const unsigned int M3_SIZE = 1024; //one block for K (16), one block for IV (16) and the encrypted key
