...
const unsigned int INPUT_SIZE = 10000; //da cambiare
const unsigned int GENERAL_MSG_SIZE = INPUT_SIZE + sizeof(unsigned int) + BLOCK_SIZE + SIGNATURE_SIZE; //da cambiare
